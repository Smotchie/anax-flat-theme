...
# LESS and CSS
LESS 		 	= style.less base.less light.less color.less colorful.less dark.less typo.less default.less photo.less texture.less gradient.less contrast.less simple.less#style1.less #style2.less
